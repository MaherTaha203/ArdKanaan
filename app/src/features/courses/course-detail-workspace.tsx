...
// A single course: its details, a quick summary, and the enrolled students with
// each one's fee / paid / remaining and payment status (textual, not colour-only).
    ...
    <div className="space-y-6">
      ...
      {stats ? (
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          ...
          <SummaryTile label="إجمالي الرسوم" money={stats.totalFees} />
