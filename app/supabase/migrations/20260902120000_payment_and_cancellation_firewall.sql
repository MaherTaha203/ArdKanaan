-- Complete the financial firewall for outgoing vouchers and make cancellation terminal.
-- Posted financial facts are immutable. A cancelled voucher is immutable thereafter.
...
-- A cancelled receipt is terminal too. The existing receipt firewall already protects
-- its financial fields; this closes the remaining loophole where cancellation metadata
-- or descriptive fields could be changed after cancellation.
