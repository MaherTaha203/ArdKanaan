...
| 5 | **Component Library Specification** | Design language + component contracts — **CMP-NNN** documents / **CP-NNN** atoms; as specification documents, **no code/HTML/CSS**. Governing plan **P5-000** (LIVING v1.0.0, ADR-0069); runs under **Owner-controlled design approval** (P5-000 §4) | `docs/components/` | ✅ **OPEN / IN PROGRESS** — opened 2026-07-29 (ADR-0069); GOV-011 §2 met (Phase 4 CLOSED; gates passed; Owner authorization). VEM authorized (ADR-0070); **first design decision approved — general visual direction** (ADR-0071: Direction ④ "operational simplicity" structure + Vercel-style light monochrome palette, light-only; direction only, no token frozen). Next: **CC1 — CMP-001 Design-Language framework** (Stage-1 Architectural Discovery), pending Owner go-ahead |
