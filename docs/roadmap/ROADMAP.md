...
| 4 | **DDL Specification** | Documented data model (`DB-NNN`): entities, attributes, keys, constraints, integrity rules — as specification documents, **not** executable SQL | `docs/data/` | 🔵 **IN PROGRESS** — opened 2026-07-22 (ADR-0060); **P4-000** DDL Specification Master Plan adopted (LIVING v1.1.0); **DC1 COMPLETE — DAT-001 Data Model Constitution FROZEN v1.0.0** (2026-07-28, ADR-0061 / AUD-P4-001; six-kind DB-atom taxonomy, the Authority Boundary grounded in constitutional authority, technology-neutral logical representation; reviewed under GOV-013, 6/6 Panel SOUND + Judge READY); **DC2 begun — DAT-002 Party Entities (Student & Teacher) FROZEN v1.0.0** (2026-07-28, ADR-0063 / AUD-P4-002; DB-001…DB-021; 6/6 Panel SOUND + Judge READY), preceded by the **DR-091** person-identity amendment (ADR-0062, DOM-004 v3.10.0); documents the data model as specification (DAT-NNN docs / DB atoms), NOT executable SQL; next: DAT-003 (Programs & Registrations) |
