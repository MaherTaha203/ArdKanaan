...
| UNK-021 | Are there ever deductions from a teacher's share (fees, penalties, materials costs)? **Intentionally postponed by Owner order (ADR-0015 S4-D8): no deduction model may be invented; this stays open until the Owner explicitly authorizes it.** | Edge of DR-012. | DR-012 |
...
4. Current tally (2026-07-17, post-Session 4): **14 open** (3 HIGH: UNK-006,
   UNK-007, UNK-009; 6 MEDIUM; 5 LOW), 11 resolved (UNK-001, UNK-002, UNK-004,
   UNK-008, UNK-010, UNK-011, UNK-012, UNK-014, UNK-020, UNK-025 answered;
   UNK-024 mooted by scope), 1 assumption rejected (ASM-002), 2 confirmed
   (ASM-001, ASM-003), 1 awaiting confirmation (ASM-004).
