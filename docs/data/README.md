...
- **DC2 — Entities & attributes:** DAT-002 (Parties) ✅ **FROZEN**; DAT-003 (Programs & Registrations) ✅ **FROZEN**; DAT-004 (Vouchers) ✅ **FROZEN**; DAT-005 (Derived Balances) ✅ **FROZEN**; DAT-006 (activity timeline) *next*.
